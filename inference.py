...
def init_args():
    ...
    parser.add_argument("--file_path", default='rest14', type=str, required=True,
    ...
    parser.add_argument("--ckpt", default='outputs/tasd/rest15/annotation/cktepoch=18.ckpt', type=str, required=True)
...
if __name__ == "__main__":
    ...
    input_data = MyDataset(tokenizer=tokenizer, file_path=args.file_path,
                            paradigm=args.paradigm, task=args.task, max_len=args.max_seq_length)
